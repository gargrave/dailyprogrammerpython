...
SOURCE = '9.20 8.03 10.02 8.08 8.14 8.10 8.31 8.28 8.35 8.34 8.39 8.45 8.38 ' \
...
INPUT = [float(i) for i in SOURCE.split()]


def main():
    dp_utils.print_title('249a', 'Stock Ticker')
    ...
    high = (0, 0)
    for idx, i in enumerate(INPUT[low[1]+2:]):
        if i > high[0]:
            high = (i, idx)

    print('{} {}'.format(low[0], high[0]))
